...
export const Navbar = () => {
  ...
  return (
    <div className='flex-center fixed top-0 z-50 w-screen flex-col'>
      <nav
        className={clsx(
          'flex h-16 w-full max-w-360 flex-row items-center justify-between gap-4 bg-black px-4 sm:h-20 sm:px-12 lg:px-30 xl:gap-0'
        )}
      >
        <Sociality />
        ...
        <InputGroup
          ...
          className={clsx(
            'sm:flex-center hidden h-12 w-full gap-1.5 rounded-full border border-neutral-900 bg-neutral-950 px-0 py-2 shadow-none md:max-w-122.75'
          )}
        >
          <InputGroupInput
            value={searchText}
        ...
        {!isLoggedIn && (
          <div className='sm:flex-center hidden gap-3'>
            <Button asChild variant='outline' size='default' className='w-32.5'>
      ...
      {openSearchField && (
        <div className='flex-center w-full px-4'>
          <InputGroup
            onKeyDown={(e) => handleSearch(e.key)}
            className={clsx(
              'flex-center h-12 w-full gap-1.5 rounded-full border border-neutral-900 bg-neutral-950 px-0 py-2 shadow-none md:max-w-122.75'
            )}
          >
            <InputGroupInput
              value={searchText}
      ...
      {/* Login/Register Button*/}
      {showAuthbutton && (
        <div className='flex w-full flex-row items-start justify-center gap-3 px-4'>
          <Button
            variant='outline'
            size='default'
