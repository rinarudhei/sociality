      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background data-[state=open]:bg-accent absolute top-4 right-4 cursor-pointer rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-0 focus:outline-hidden disabled:pointer-events-none data-[state=open]:text-neutral-950 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
